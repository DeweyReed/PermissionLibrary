...
class RoundTextView : AppCompatTextView {
    ...
    private fun extractAttribute(context: Context, attrs: AttributeSet) {
        ...
        try {
            ...
            tvAllCorner = ta.getDimension(R.styleable.RoundTextView_allCorner, java.lang.Float.MIN_VALUE)
            tvTopLeftCorner = ta.getDimension(R.styleable.RoundTextView_topLeftCorner, DEFAULT_CORNER.toFloat())
            tvTopRightCorner = ta.getDimension(R.styleable.RoundTextView_topRightCorner, DEFAULT_CORNER.toFloat())
            tvBottomRightCorner = ta.getDimension(R.styleable.RoundTextView_bottomRightCorner, DEFAULT_CORNER.toFloat())
            tvBottomLeftCorner = ta.getDimension(R.styleable.RoundTextView_bottomLeftCorner, DEFAULT_CORNER.toFloat())
        } finally {
            ta.recycle()
        }
    }
...
//    }
    ...
    private fun setViewBackground() {
        val drawable = if (tvAllCorner != java.lang.Float.MIN_VALUE) {
            ...
            getCornerDrawable(tvTopLeftCorner, tvTopRightCorner,
                    tvBottomLeftCorner, tvBottomRightCorner,
                    tvBgColor)
        }
...
//        private val DEFAULT_ALL_CORNER = Integer.MIN_VALUE
        ...
        fun getCornerDrawable(topLeft: Float, topRight: Float, bottomLeft: Float, bottomRight: Float,
